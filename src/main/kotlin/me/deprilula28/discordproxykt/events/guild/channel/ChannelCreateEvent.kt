...
class ChannelCreateEvent(override val map: JsonObject, override val bot: DiscordProxyKt): GuildChannelEvent {
    ...
    override suspend fun internalHandle() {
        guild.upgrade().getIfAvailable()?.apply { cachedChannels.add(channel) }
    }
}
