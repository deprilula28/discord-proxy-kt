...
class Embed(private val map: JsonObject, val bot: JdaProxySpectacles) {
    ...
    class Field(private val map: JsonObject, val bot: JdaProxySpectacles) {
    ...
    class Footer(private val map: JsonObject, val bot: JdaProxySpectacles) {
    ...
    class Image(private val map: JsonObject, val bot: JdaProxySpectacles) {
    ...
    class Provider(private val map: JsonObject, val bot: JdaProxySpectacles) {
        val name: String? by lazy { map["name"]?.asString() }
        val url: String? by lazy { map["url"]?.asString() }
    }
    ...
    class Author(private val map: JsonObject, val bot: JdaProxySpectacles) {
        val name: String? by lazy { map["name"]?.asString() }
        val url: String? by lazy { map["url"]?.asString() }
        val sourceIconUrl: String? by lazy { map["icon_url"]?.asString() }
        val proxyIconUrl: String? by lazy { map["proxy_icon_url"]?.asString() }
